...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'brand':      '0 0 30px -5px rgba(212,175,55,0.35)',
        'brand-sm':   '0 0 15px -3px rgba(212,175,55,0.25)',
        'brand-lg':   '0 0 60px -10px rgba(212,175,55,0.45)',
        'cyan-glow':  '0 0 30px -5px rgba(16,185,129,0.35)',
      ...
      backgroundImage: {
        'mesh-hero':        'radial-gradient(ellipse at 20% 50%, rgba(212,175,55,0.12) 0%, transparent 50%), radial-gradient(ellipse at 80% 20%, rgba(16,185,129,0.08) 0%, transparent 50%), radial-gradient(ellipse at 50% 80%, rgba(184,150,46,0.06) 0%, transparent 60%)',
        ...
        'gradient-brand':   'linear-gradient(135deg, #D4AF37 0%, #b8962e 100%)',
        'gradient-hero':    'linear-gradient(135deg, #D4AF37 0%, #10B981 100%)',
        'gradient-gold':    'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)',
        'gradient-surface': 'linear-gradient(135deg, #0D1F3C 0%, #142847 100%)',
      ...
      keyframes: {
        'glow-pulse': {
          ...
          '50%':       { boxShadow: '0 0 25px 5px rgba(212,175,55,0.2)' },
        },
        'shimmer': {
