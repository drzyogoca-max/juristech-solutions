...
export const GLOBAL_TRANSLATIONS: Record<SupportedLang, GlobalUITexts> = {
  ar: {
    nav: {
      ...
      sovereignAiHub: '⭐ محرك JurisTech AI',
    ...
    dashboard: {
      ...
      startConsultation: 'بدء التحليل الذكي 24/7',
      ...
      statAiQueries: 'عمليات التحليل بالذكاء الاصطناعي',
    ...
    aiHub: {
      title: 'مركز حلول الذكاء الاصطناعي السيادي | JurisTech AI',
    ...
    chat: {
      title: 'محرك التحليل القانوني الذكي للشركات',
      subtitle: 'تحليل قانوني آلي وتأصيل تشريعي دقيق 24/7',
    ...
    footer: {
      ...
      headquarters: 'منصة رقمية عالمية تعمل عن بعد',
      ammanHq: 'منصة رقمية عالمية تعمل عن بعد',
    },
  },
  ...
  en: {
    ...
    dashboard: {
      ...
      startConsultation: 'Start AI Contract Analysis 24/7',
      ...
      statAiQueries: 'AI Legal Analyses',
    ...
    aiHub: {
      title: 'Sovereign AI Solutions Hub | JurisTech AI',
    ...
    chat: {
      title: 'Corporate AI Legal Intelligence Engine',
      subtitle: 'Automated statutory answers and cross-border commercial analysis 24/7',
    ...
    footer: {
      ...
      headquarters: 'Global Digital Platform — Operated remotely',
      ammanHq: 'Global Digital Platform — Operated remotely',
    },
  },
  ...
  de: {
    nav: {
      ...
      bookAdvisor: 'Unternehmenssupport',
    ...
    dashboard: {
      ...
      startConsultation: 'KI-Vertragsanalyse starten 24/7',
      ...
      statAiQueries: 'KI-Rechtsanalysen',
    ...
    aiHub: {
      title: 'Souveränes KI-Lösungszentrum | JurisTech AI',
    ...
    chat: {
      title: 'KI-gestützte Rechtsanalyse für Unternehmen',
      subtitle: 'Automatisierte Rechtsanalyse und Auslegung nach BGB/HGB und internationalem Recht 24/7',
    ...
    footer: {
      ...
      headquarters: 'Globale digitale Plattform — Remote betrieben',
      ammanHq: 'Globale digitale Plattform — Remote betrieben',
    },
  },
  ...
  fr: {
    nav: {
      ...
      bookAdvisor: 'Support Entreprise',
    ...
    dashboard: {
      ...
      startConsultation: 'Démarrer l’analyse IA 24/7',
      ...
      statAiQueries: 'Analyses contractuelles IA',
    ...
    aiHub: {
      title: 'Centre de Solutions IA Souveraines | JurisTech AI',
    ...
    chat: {
      title: 'Moteur d’intelligence juridique IA pour entreprises',
      subtitle: 'Analyses juridiques automatisées et conformité réglementaire 24/7',
    ...
    footer: {
      ...
      headquarters: 'Plateforme numérique mondiale — Fonctionnement à distance',
      ammanHq: 'Plateforme numérique mondiale — Fonctionnement à distance',
    },
  },
  ...
  es: {
    nav: {
      ...
      bookAdvisor: 'Soporte Corporativo',
    ...
    dashboard: {
      ...
      startConsultation: 'Iniciar análisis inteligente 24/7',
      ...
      statAiQueries: 'Análisis contractuales IA',
    ...
    aiHub: {
      title: 'Centro de Soluciones IA Soberanas | JurisTech AI',
    ...
    chat: {
      title: 'Motor de inteligencia jurídica IA para empresas',
      subtitle: 'Análisis legal automatizado y soporte normativo 24/7',
    ...
    footer: {
      ...
      headquarters: 'Plataforma digital global — Operada de forma remota',
      ammanHq: 'Plataforma digital global — Operada de forma remota',
    },
  },
  ...
  zh: {
    ...
    dashboard: {
      ...
      startConsultation: '启动AI智能分析 24/7',
    ...
    chat: {
      title: '企业级AI法律智能引擎',
      subtitle: '基于权威法典与国际商事法律的24/7自动化法律分析',
    ...
    footer: {
      ...
      headquarters: '全球数字化平台 — 远程运营',
      ammanHq: '全球数字化平台 — 远程运营',
    },
  },
  ...
  tr: {
    ...
    dashboard: {
      ...
      startConsultation: '7/24 Yapay Zeka Analizi Başlat',
      ...
      statAiQueries: 'Yapay Zeka Hukuki Analizleri',
    ...
    aiHub: {
      title: 'Egemen Yapay Zeka Çözüm Merkezi | JurisTech AI',
    ...
    chat: {
      title: 'Kurumsal Yapay Zeka Hukuk Motoru',
      subtitle: 'Türk Hukuku (TTK, TBK) ve uluslararası mevzuata dayalı 7/24 otomatik hukuki analiz',
    ...
    footer: {
      ...
      headquarters: 'Küresel Dijital Platform — Uzaktan işletilmektedir',
      ammanHq: 'Küresel Dijital Platform — Uzaktan işletilmektedir',
    },
  },
};
