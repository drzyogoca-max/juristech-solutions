...
export const UI_TRANSLATIONS: Record<AppLang, ModalTranslations> = {
  ar: {
    leadCapture: {
      ...
      welcomeSub: 'سجّل بريدك الرسمي للحصول على تحليلات ذكية وتدقيق وتحديثات العقود، أو تابع التصفح واستكشاف الأدوات بحرية.',
    ...
    jurisdiction: {
      advisorBadge: 'المساعد التشريعي الدولي المباشر (35+ دولة)',
    ...
    consultation: {
      badge: 'طلب استعراض المنصة وسير العمل الآلي',
      headerBadge: 'طلب استعراض وسير العمل القانوني الآلي',
      title: 'طلب جلسة استعراض وحوكمة مخاطر مخصصة',
      subtitle: 'تواصل مباشرة لاستعراض حوكمة الصفقات وتدقيق المخاطر البرمجية والنزاعات الدولية.',
      selectAdvisor: 'مسؤول الحلول والدعم التقني',
      consultationType: 'طريقة استعراض المنصة',
      typeEmail: '📧 مذكرة تحليل مكتوبة وموثقة',
      typeVideo: '📹 جلسة استعراض فيديو مباشرة (45 دقيقة)',
      ...
      subjectDetails: 'ملخص موضوع التحليل أو العقد محل المراجعة',
      subjectPlaceholder: 'اشرح بإيجاز طبيعة التحليل أو الأطراف المعنية أو البنود المراد تدقيقها...',
      submitBtn: 'تأكيد وإرسال طلب الاستعراض',
      submittingBtn: 'جارٍ إرسال الطلب...',
      successTitle: 'تم استلام طلب الاستعراض بنجاح!',
      successSub: 'تم تسجيل طلبك وسيتم التواصل معك مباشرة لتزويدك بالمواد والرابط.',
      ...
      confirmedDesc: 'تم إرسال تفاصيل الطلب مباشرة إلى البريد الإلكتروني الرسمي وبريد العميل. سيتم الرد المباشر بتقرير التحليل.',
      doneBtn: 'تم',
    },
    chatbot: {
      ...
      nextStepDesc: 'يمكنك الآن ترقية خطتك للوصول غير المحدود، أو تصدير وتوقيع عقدك الموثق.',
      bookConsultationBtn: '⚡ طلب استعراض المنصة',
      ...
      pills: [
        { label: '📜 توليد العقود المليونية وقفل الاختصاص', query: 'ما هي آلية توليد العقود المليونية المتخصصة والتحقق من التوافق القانوني الجغرافي Jurisdiction Lock؟' },
        { label: '📄 دقة تصدير Word والاتجاهات RTL/LTR', query: 'هل ملفات الورد (Word .docx) المستخرجة متوافقة مع الاتجاهات اللغوية (RTL/LTR) وخالية من الفراغات؟' },
        { label: '🏢 ربط الحسابات المؤسسية وباقات الشركات', query: 'ما هي خطوات ربط الحسابات المؤسسية الكبرى وباقات الشركات المخصصة؟' },
        { label: '⚖️ غرفة التفاوض الرقمية الذكية', query: 'ما هي آلية الاستفادة القصوى من غرف التفاوض الرقمية الذكية وحل النزاعات التعاقدية؟' },
        { label: '🛡️ تحديد المسؤولية والقوة القاهرة', query: 'كيف أصيغ بند القوة القاهرة وتحديد سقف المسؤولية والتعويضات وفق المعايير الدولية؟' },
        { label: '🔒 اتفاقية السرية وحماية الأسرار NDA', query: 'ما هي البنود الجوهرية في اتفاقية عدم الإفصاح وحماية الأسرار التجارية؟' },
      ],
    },
    companyProfile: {
    ...
    liveMeeting: {
      badge: 'غرفة عمل وتفاوض مباشرة مشفرة',
      title: 'جلسة تفاوض ومراجعة مرئية مباشرة',
      subtitle: 'انضم لغرفة الاجتماع المرئي المشفرة لمراجعة وتوقيع العقود لحظياً.',
  ...
  en: {
    ...
    jurisdiction: {
      advisorBadge: 'International Legislative Assistant (>35 Countries)',
    ...
    consultation: {
      ...
      title: 'Strategic Workflow Demo & Risk Governance Request',
      subtitle: 'Connect directly for automated cross-border deal structuring, regulatory risk audits, and dispute resolution tools.',
      selectAdvisor: 'Solutions & Technical Specialist',
      consultationType: 'Session Format',
      ...
      confirmedTitle: 'Session Request Confirmed & Dispatched!',
    ...
    chatbot: {
      ...
      nextStepDesc: 'Proceed to upgrade to an unlimited plan, or export and sign your certified contract.',
      bookConsultationBtn: '⚡ Request Workflow Demo',
      ...
      pills: [
        { label: '📜 Million+ Contracts & Jurisdiction Lock', query: 'How does the specialized 1,000,000+ contract generation and Jurisdiction Lock engine work?' },
        { label: '📄 Word DOCX & RTL/LTR Precision', query: 'Are Word (.docx) file downloads 100% compliant with language direction (RTL/LTR) and zero whitespace gaps?' },
        { label: '🏢 Enterprise Accounts & Custom SLAs', query: 'What are the steps to link Multi-Seat Enterprise corporate accounts and custom SME retainers?' },
        { label: '⚖️ Digital Negotiation Chambers', query: 'How do I maximize the use of Digital Negotiation Chambers to resolve contract disputes?' },
        { label: '🛡️ Liability Capping & Force Majeure', query: 'How do I draft robust liability capping and Force Majeure clauses under international standards?' },
        { label: '🔒 Non-Disclosure Agreements (NDA)', query: 'What are the essential statutory clauses in a mutual Non-Disclosure Agreement?' },
      ],
    },
    companyProfile: {
    ...
    liveMeeting: {
      badge: 'Encrypted Live Workflow Room',
      title: 'Live Video Negotiation & Workflow Room',
      subtitle: 'Join the end-to-end encrypted video session with technical workflow specialists to review and execute agreements in real time.',
  ...
  fr: {
    ...
    jurisdiction: {
      advisorBadge: 'Assistant Législatif International (35+ pays)',
    ...
    chatbot: {
      ...
      bookConsultationBtn: '⚡ Demander une Démo',
  ...
  de: {
    ...
    jurisdiction: {
      advisorBadge: 'Internationaler Rechtsassistent (35+ Länder)',
    ...
    chatbot: {
      ...
      bookConsultationBtn: '⚡ Demo anfordern',
  ...
  es: {
    ...
    jurisdiction: {
      advisorBadge: 'Asistente Legislativo Internacional (35+ países)',
    ...
    chatbot: {
      ...
      bookConsultationBtn: '⚡ Solicitar Demostración',
  ...
  zh: {
    ...
    jurisdiction: {
      advisorBadge: '国际法律助手体系（覆盖 35+ 个国家）',
      title: '选择司法管辖区与法律体系',
  ...
  tr: {
    ...
    jurisdiction: {
      advisorBadge: 'Uluslararası Hukuk Asistanı (35+ Ülke)',
    ...
    chatbot: {
      ...
      bookConsultationBtn: '⚡ Demo Talep Et',
