...
export const JURISDICTION_PROFILES: Record<string, JurisdictionLegalProfile> = {
  ...
  SG: {
    ...
    countryEn: 'Republic of Singapore',
    governingLawAr: 'القانون التجاري السنغافوري وقانون الشركات (Companies Act Cap. 50) وقانون تطبيق العقود (Contract Law Application Act)',
    governingLawEn: 'Singapore Companies Act (Cap. 50, 2006 Rev. Ed.) & Contract Law (Application) Act — governed by Singapore law',
    exclusiveCourtsAr: 'المحكمة التجارية العليا في سنغافورة (Singapore High Court — Commercial Division) والمحكمة التجارية الدولية في سنغافورة (SICC)',
    exclusiveCourtsEn: 'Singapore High Court (Commercial Division) & Singapore International Commercial Court (SICC)',
    arbitrationCenterAr: 'مركز التحكيم الدولي في سنغافورة (SIAC) وفق أحدث قواعد SIAC المعمول بها',
    arbitrationCenterEn: 'Singapore International Arbitration Centre (SIAC) under the latest SIAC Arbitration Rules',
    currency: 'دولار سنغافوري',
    currencyCode: 'SGD',
    statutoryCodes: ['Singapore Companies Act Cap. 50', 'SIAC Rules 2016', 'Singapore Contract Law', 'PDPA 2012', 'International Arbitration Act Cap. 143A'],
  },

  IN: {
    code: 'IN',
    countryAr: 'جمهورية الهند',
    countryEn: 'Republic of India',
    governingLawAr: 'قانون العقود الهندي لسنة 1872 (Indian Contract Act 1872) وقانون الشركات الهندي لسنة 2013 (Companies Act 2013)',
    governingLawEn: 'Indian Contract Act 1872 & Companies Act 2013 — governed by Indian law',
    exclusiveCourtsAr: 'المحكمة العليا في دلهي أو بومباي أو المحاكم التجارية المختصة وفق قانون المحاكم التجارية 2015',
    exclusiveCourtsEn: 'Delhi High Court / Bombay High Court / Competent Commercial Courts under the Commercial Courts Act 2015',
    arbitrationCenterAr: 'مركز التحكيم الدولي في مومباي (MCIA) أو مركز ICC الهند',
    arbitrationCenterEn: 'Mumbai Centre for International Arbitration (MCIA) or ICC India — under Arbitration & Conciliation Act 1996 (as amended 2019)',
    currency: 'روبية هندية',
    currencyCode: 'INR',
    statutoryCodes: ['Indian Contract Act 1872', 'Companies Act 2013', 'Arbitration & Conciliation Act 1996', 'PDPB 2022', 'Commercial Courts Act 2015'],
  },

  AU: {
    code: 'AU',
    countryAr: 'كومنولث أستراليا',
    countryEn: 'Commonwealth of Australia',
    governingLawAr: 'قانون الشركات الأسترالي لسنة 2001 (Corporations Act 2001) وقانون حماية المستهلك الأسترالي (ACL) المنبثق عن قانون المنافسة والمستهلك 2010',
    governingLawEn: 'Australian Corporations Act 2001 (Cth) & Australian Consumer Law (ACL) — Schedule 2 of the Competition and Consumer Act 2010',
    exclusiveCourtsAr: 'المحكمة الفيدرالية الأسترالية — الدائرة التجارية وقائمة الشركات (Federal Court of Australia — Commercial & Corporations List)',
    exclusiveCourtsEn: 'Federal Court of Australia (Commercial & Corporations List) or the relevant Supreme Court of the applicable State/Territory',
    arbitrationCenterAr: 'المركز الأسترالي للتحكيم التجاري الدولي (ACICA) وفق قواعد ACICA للتحكيم',
    arbitrationCenterEn: 'Australian Centre for International Commercial Arbitration (ACICA) under ACICA Arbitration Rules',
    currency: 'دولار أسترالي',
    currencyCode: 'AUD',
    statutoryCodes: ['Corporations Act 2001 (Cth)', 'Australian Consumer Law', 'ACICA Rules', 'Privacy Act 1988 (Cth)', 'Fair Work Act 2009'],
  },
  ...
  CA: {
    ...
    countryAr: 'كندا',
    countryEn: 'Canada',
    governingLawAr: 'قانون الشركات التجارية الكندي (CBCA — Canada Business Corporations Act R.S.C. 1985) وقوانين المقاطعات التجارية المعمول بها',
    governingLawEn: 'Canada Business Corporations Act (CBCA, R.S.C. 1985) & applicable Provincial Commercial Law (Ontario OBCA / British Columbia BCBCA)',
    exclusiveCourtsAr: 'محكمة أونتاريو العليا لقضايا العدل (Ontario Superior Court of Justice) أو المحكمة العليا لبريتيش كولومبيا — الدائرة التجارية',
    exclusiveCourtsEn: 'Ontario Superior Court of Justice / British Columbia Supreme Court (Commercial Division) — as applicable per governing province',
    arbitrationCenterAr: 'مركز ADR Chambers كندا أو ICC كندا وفق قواعد التحكيم التجاري الكندية',
    arbitrationCenterEn: 'ADR Chambers Canada / ICC Canada under Canadian Commercial Arbitration Rules',
    currency: 'دولار كندي',
    currencyCode: 'CAD',
    statutoryCodes: ['Canada Business Corporations Act (CBCA)', 'PIPEDA Privacy Law', 'Competition Act (Canada)', 'ICC Rules', 'Ontario OBCA'],
  },
};
