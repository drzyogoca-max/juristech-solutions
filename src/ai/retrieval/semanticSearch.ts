...
const JURISDICTION_KEYWORDS: Record<JurisdictionCode, string[]> = {
  ...
  OM: ['oman', 'muscat', 'muscat', 'مسقط', 'umman', '阿曼'],
  JO: ['jordan', 'jordanian', 'jordanian law', 'الأردن', 'الأردني', 'اردني', 'أردني', 'القانون الأردني', 'المملكة الأردنية', 'ccd', 'jordanie', 'jordania', 'jordanien', 'ürdün', '约旦'],
