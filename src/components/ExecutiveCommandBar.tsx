      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <span className="text-[11px] font-black uppercase tracking-wider text-amber-400 flex items-center gap-1">
                ...
                <span>{isRtl ? 'المستشار د. محمد مصطفى' : 'Dr. Mohammad Mustafa'}</span>
              </span>
              <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-500/15 text-emerald-300 border border-emerald-500/30 flex items-center gap-1">
                ...
                <span>{isRtl ? 'استشارات فورية 24/7' : 'Live Advisory 24/7'}</span>
              </span>
            </div>

            <h2 className="text-sm sm:text-base font-black text-white mt-0.5">
              {isRtl ? 'مركز القيادة والخدمات القانونية السيادية' : 'Sovereign Executive Legal Command Center'}
            </h2>
        ...
        <div className="flex items-center gap-2 w-full lg:w-auto flex-wrap sm:flex-nowrap">
          ...
          <a
            ...
            aria-label={isRtl ? 'واتساب المستشار المباشر' : 'WhatsApp Counsel'}
          ...
          >
            ...
            <span className="truncate">{isRtl ? 'البريد الرسمي' : 'Direct Email'}</span>
          </a>

          {/* InstaPay Quick Info */}
          <Link
            to="/payment"
            aria-label={isRtl ? 'إنستا باي والدفع الفوري' : 'InstaPay & Checkout'}
          ...
          >
            ...
            <span className="truncate">{isRtl ? 'إنستا باي: 01031222262' : 'InstaPay'}</span>
          </Link>
          ...
          {onOpenSecurity && (
            <button
              ...
              aria-label={isRtl ? 'أمان التشفير 2FA' : '2FA Security'}
              ...
              title={isRtl ? 'إدارة الأمان والمصادقة الثنائية' : '2FA Security Settings'}
            >
