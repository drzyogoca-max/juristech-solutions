...
export const ACTIVE_RAG_KNOWLEDGE_BASE: RAGKnowledgeEntry[] = [
  ...
  {
    id: 'rag-jo-poa-general',
    category: 'Jordanian General Power of Attorney & Notary Public Law',
    jurisdiction: 'JO',
    queryPattern: 'نموذج وكالة عامة تفويض شخص وفقا للقانون الاردني الكاتب العدل قانون التوثيق عقد الوكالة القانون المدني الاردني',
    statutoryContext: 'ينظم عقد الوكالة والوكالة العامة في المملكة الأردنية الهاشمية أحكام المواد 833 حتى 867 من القانون المدني الأردني رقم 43 لسنة 1976 وتصديق الكاتب العدل وفق قانون الكاتب العدل رقم 11 لسنة 1952. تشمل الوكالة العامة التفويض في إدارة الأموال، مراجعة الوزارات والدوائر الرسمية (دائرة مراقبة الشركات CCD، دائرة الأراضي، الضريبة، الجمارك، أمانة عمان)، الحسابات البنكية، والتقاضي وتعيين المحامين، مع وجوب النص الصريح للتصرفات العقارية الناقلة للملكية وفق قانون الملكية العقارية الأردني رقم 13 لسنة 2019.',
    confidenceScore: 0.99,
  },
  ...
  // ── NEW: SG, IN, AU, CA Statutory Entries ─────────────────────────────────
  {
    id: 'rag-sg-companies-act-siac',
    category: 'Singapore Corporate & Commercial Law',
    jurisdiction: 'SG',
    queryPattern: 'Singapore Companies Act Cap 50 SIAC Arbitration PDPA',
    statutoryContext: 'Governed by Singapore Companies Act (Cap. 50, 2006 Rev. Ed.), Contract Law (Application) Act, Singapore International Arbitration Act (Cap. 143A), and Personal Data Protection Act (PDPA 2012). Disputes resolved by Singapore International Arbitration Centre (SIAC) or Singapore International Commercial Court (SICC). Singapore applies English common law principles supplemented by local legislation.',
    confidenceScore: 0.96,
  },
  {
    id: 'rag-sg-employment-ip-law',
    category: 'Singapore Employment & IP Law',
    jurisdiction: 'SG',
    queryPattern: 'Singapore Employment Act Cap 91 IP Copyright Patent',
    statutoryContext: 'Employment governed by Singapore Employment Act (Cap. 91). IP protection under Copyright Act 2021 (Revised Edition), Patents Act (Cap. 221), and Trade Marks Act (Cap. 332). Non-compete clauses must satisfy reasonableness test under Singapore common law. MOM (Ministry of Manpower) regulations apply to employment contracts.',
    confidenceScore: 0.94,
  },
  {
    id: 'rag-in-contract-act-companies',
    category: 'Indian Corporate & Contract Law',
    jurisdiction: 'IN',
    queryPattern: 'India Contract Act 1872 Companies Act 2013 MCIA Arbitration',
    statutoryContext: 'Governed by Indian Contract Act 1872, Companies Act 2013 (MCA), and Specific Relief Act 1963. Arbitration under Arbitration & Conciliation Act 1996 (amended 2019/2021), administered by Mumbai Centre for International Arbitration (MCIA). SEBI regulations apply to capital market transactions. GST Act 2017 for tax provisions.',
    confidenceScore: 0.95,
  },
  {
    id: 'rag-in-ip-data-protection',
    category: 'Indian IP & Data Protection Law',
    jurisdiction: 'IN',
    queryPattern: 'India IP Copyright Patent Trade Mark DPDP Act 2023',
    statutoryContext: 'IP protection under Indian Copyright Act 1957, Patents Act 1970, and Trade Marks Act 1999. Data protection governed by Digital Personal Data Protection (DPDP) Act 2023 — comprehensive data protection framework replacing IT Act 2000 provisions. Foreign investment regulated under FEMA 1999 and DPIIT FDI Policy.',
    confidenceScore: 0.93,
  },
  {
    id: 'rag-au-corporations-act-acica',
    category: 'Australian Corporate & Commercial Law',
    jurisdiction: 'AU',
    queryPattern: 'Australia Corporations Act 2001 ACICA Australian Consumer Law',
    statutoryContext: 'Governed by Corporations Act 2001 (Cth), Australian Consumer Law (ACL — Schedule 2 of Competition and Consumer Act 2010), and Contract Law (common law + equity). Arbitration under ACICA Rules. Privacy Act 1988 (Cth) for data protection. Fair Work Act 2009 for employment. State/territory courts apply when federal jurisdiction unavailable.',
    confidenceScore: 0.96,
  },
  {
    id: 'rag-au-ip-employment-law',
    category: 'Australian IP & Employment Law',
    jurisdiction: 'AU',
    queryPattern: 'Australia Copyright Act IP Employment Fair Work Act NDA',
    statutoryContext: 'IP under Copyright Act 1968 (Cth), Patents Act 1990, Trade Marks Act 1995. Employment governed by Fair Work Act 2009 and National Employment Standards (NES). Non-compete clauses enforced subject to reasonableness (restraint of trade doctrine). Privacy Act 1988 — Australian Privacy Principles (APPs) apply to data handling.',
    confidenceScore: 0.94,
  },
  {
    id: 'rag-ca-cbca-provincial-law',
    category: 'Canadian Corporate & Commercial Law',
    jurisdiction: 'CA',
    queryPattern: 'Canada CBCA Business Corporations Act Ontario OBCA ADR Arbitration',
    statutoryContext: 'Governed by Canada Business Corporations Act (CBCA, R.S.C. 1985) federally, or provincial legislation (Ontario Business Corporations Act — OBCA, BC Business Corporations Act). Commercial contracts governed by common law (except Québec — Civil Code of Québec). Arbitration under ADR Chambers or International Commercial Arbitration Act of the applicable province. PIPEDA (Privacy) and Anti-Spam Law (CASL) apply.',
    confidenceScore: 0.95,
  },
  {
    id: 'rag-ca-competition-ip-privacy',
    category: 'Canadian Competition, IP & Privacy Law',
    jurisdiction: 'CA',
    queryPattern: 'Canada Competition Act IP Copyright Patent PIPEDA Privacy CASL',
    statutoryContext: 'Competition law under Canada Competition Act (RSC 1985). IP: Copyright Act (RSC 1985 c. C-42), Patent Act, Trade-marks Act. Privacy: PIPEDA (Personal Information Protection and Electronic Documents Act) — superseded provincially by PIPA in BC/AB. Anti-spam: CASL (Canada Anti-Spam Legislation). Employment governed by provincial standards + Canada Labour Code for federally regulated employees.',
    confidenceScore: 0.93,
  },
];
