...
const JURISDICTIONS: JurisdictionConfig[] = [
  ...
  { code: 'JO', nameAr: 'المملكة الأردنية الهاشمية', nameEn: 'Jordan', flag: '🇯🇴', statutesAr: 'القانون المدني الأردني وقانون التجارة الإلكترونية', statutesEn: 'Jordanian Civil Code & E-Commerce Regulations' },
