...
const JURISDICTIONS: JurisdictionConfig[] = [
  ...
  { code: 'JO', nameAr: 'المملكة الأردنية الهاشمية', nameEn: 'Jordan', flag: '🇯🇴', statutesAr: 'القانون المدني الأردني، قانون حماية حق المؤلف رقم 22، ومحاكم عمّان', statutesEn: 'Jordanian Civil Code, IP Protection Law 22, Amman Courts' },
