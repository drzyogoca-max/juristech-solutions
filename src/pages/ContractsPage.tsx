  ...
  return (
    <main className="p-4 sm:p-6 lg:p-8 min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 font-sans" dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 font-bold text-xs text-slate-900 dark:text-white flex items-center gap-2 transition-all shadow-lg shadow-indigo-600/30"
            >
        ...
        {/* 4 Multi-AI Sovereign Workflow Pillars */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Step 01 */}
          <div className="p-4 rounded-3xl bg-slate-900/90 border border-cyan-500/30 space-y-2 relative overflow-hidden group">
            <div className="flex items-center justify-between">
              <span className="text-xl font-black text-cyan-400 font-mono">01</span>
              <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">
                Automated 100% Compliant
              </span>
            </div>
            <h4 className="font-extrabold text-xs text-white flex items-center gap-1.5">
              <Upload className="w-4 h-4 text-cyan-400" />
              <span>Smart Upload & Native OCR Extraction</span>
            </h4>
            <p className="text-[11px] text-slate-300 leading-relaxed">
              Attach contracts (PDF, DOCX, TXT) for multi-stage OCR extraction preserving 100% native language integrity.
            </p>
            <label className="inline-flex items-center gap-1.5 mt-2 px-3 py-1.5 rounded-xl bg-cyan-500/20 text-cyan-300 hover:bg-cyan-500/30 text-[11px] font-bold cursor-pointer border border-cyan-500/40 transition-all">
              <File className="w-3.5 h-3.5" />
              <span>{isUploadingFile ? (ocrStatusMsg || 'Extracting...') : 'Attach & Extract (PDF/DOCX)'}</span>
          ...
          <div className="p-4 rounded-3xl bg-slate-900/90 border border-cyan-500/30 space-y-2 relative overflow-hidden group">
            <div className="flex items-center justify-between">
              <span className="text-xl font-black text-cyan-400 font-mono">02</span>
              <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">
                Automated 100% Compliant
              </span>
            </div>
            <h4 className="font-extrabold text-xs text-white flex items-center gap-1.5">
              ...
              <span>Heatmap Audit & Zero-Risk Redlines</span>
            </h4>
            <p className="text-[11px] text-slate-300 leading-relaxed">
          ...
          <div className="p-4 rounded-3xl bg-slate-900/90 border border-cyan-500/30 space-y-2 relative overflow-hidden group">
            <div className="flex items-center justify-between">
              <span className="text-xl font-black text-cyan-400 font-mono">03</span>
              <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">
                Automated 100% Compliant
              </span>
            </div>
            <h4 className="font-extrabold text-xs text-white flex items-center gap-1.5">
              ...
              <span>AI Compromise Room & Cryptographic E-Sign</span>
            </h4>
            <p className="text-[11px] text-slate-300 leading-relaxed">
          ...
          <div className="p-4 rounded-3xl bg-slate-900/90 border border-cyan-500/30 space-y-2 relative overflow-hidden group">
            <div className="flex items-center justify-between">
              <span className="text-xl font-black text-cyan-400 font-mono">04</span>
              <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">
                Automated 100% Compliant
              </span>
            </div>
            <h4 className="font-extrabold text-xs text-white flex items-center gap-1.5">
              ...
              <span>Bilingual PDF/Word Export & Official Seals</span>
            </h4>
            <p className="text-[11px] text-slate-300 leading-relaxed">
