...
export const EDUCATIONAL_STAGES: EducationalStage[] = [
  ...
  },
  {
    id: 2,
    durationSec: 13,
    badgeAr: 'المرحلة الثانية • التحليل التفاعلي',
    badgeEn: 'Stage 2 • AI Contract Analysis',
    titleAr: 'محرك التحليل الذكي 24/7 والدردشة القانونية المتخصصة',
    titleEn: 'Sovereign 24/7 AI Contract Intelligence & Multi-Turn Analysis',
    subtitleAr: 'تحليل قانوني آلي مدعوم بأنظمة الشركات والمعاملات المدنية وقانون العمل',
    subtitleEn: 'Automated contract reasoning, statutory citations, and risk detection before any deal',
    script: {
      ar: 'في المرحلة الثانية، يتيح لك محرك التحليل القانوني الذكي طرح أي استفسار أو تدقيق عقدي معقد على مدار 24 ساعة. يستند المحرك إلى قواعد معرفية ذكية وقوانين الشركات والمعاملات المدنية، ليقدم لك تحليلات فورية، مراجع نظامية دقيقة، ومؤشرات مخاطر استباقية قبل اتخاذ أي قرار تجاري.',
      en: 'In stage two, the Sovereign AI Contract Engine is available 24/7 to resolve complex contractual workflows. Powered by extensive statutory knowledge across corporate and civil codes, it provides automated reasoning, precise statutory references, and risk guidance before any commercial decision.',
      fr: "Dans la deuxième étape, le moteur d’analyse contractuelle IA est disponible 24h/24 pour analyser vos contrats avec des références juridiques précises et une détection immédiate des risques.",
      de: 'In Stufe zwei steht Ihnen die souveräne KI-Vertragsanalyse rund um die Uhr zur Verfügung, um Verträge mit präzisen Gesetzestexten und Risikoanalysen automatisiert zu prüfen.',
      es: 'En la etapa dos, el Motor de Análisis Contractual IA está disponible las 24 horas para analizar contratos con fundamentos normativos y detección preventiva de riesgos.',
      zh: '在第二阶段，主权AI合同智能分析引擎全天候24小时为您审查复杂合同，基于公司法与民商法知识库提供即时自动化推理与法定依据。',
      tr: 'İkinci aşamada, Bağımsız Yapay Zeka Sözleşme Analiz Motoru sözleşmelerinizi incelemek, mevzuat referansları ve risk tespiti sunmak için 7/24 hizmetinizdedir.',
    },
    icon: Brain,
    bgGradient: 'from-slate-950 via-indigo-950/40 to-slate-900',
    accentColor: '#6366f1',
    targetRoute: '/chat',
    targetButtonLabelAr: 'بدء التحليل الذكي للعقود',
    targetButtonLabelEn: 'Start AI Contract Analysis',
  ...
  },
  {
    ...
    titleAr: 'محرك صياغة العقود الذكية وخزينة النماذج المعتمدة',
    titleEn: 'AI Smart Contract Drafting Studio & Verified Templates Vault',
    subtitleAr: 'صياغة موجهة بـ 4 خطوات مع استدعاء أضخم مكتبة عقود وتوثيق SHA-256 مشفر',
    subtitleEn: 'Guided 4-step drafting with verified smart templates and SHA-256 cryptographic seal',
    script: {
      ar: 'المرحلة الثالثة تمثل قلب المنظومة: محرك الصياغة الموحد وخزينة العقود المعتمدة. يمكنك صياغة عقود تجارية ومؤسسية مخصصة عبر خريطة عمل موجهة من أربع خطوات، أو الاختيار من بين النماذج المعتمدة، مع مواءمة تشريعية فورية وختم رقمي مشفر SHA-256.',
      en: 'Stage three is the core engine: the Unified Drafting Studio and Verified Templates Vault. Generate institutional commercial contracts via a guided 4-step roadmap or search certified templates, complete with automated statutory compliance and SHA-256 cryptographic seals.',
      fr: "L'étape trois est le cœur du système : le studio de rédaction unifié et le coffre-fort de modèles certifiés. Rédigez des contrats institutionnels via une feuille de route guidée en 4 étapes avec sceau SHA-256.",
      de: 'Stufe drei ist das Herzstück: das einheitliche Vertragsstudio und der Tresor mit verifizierten Vorlagen. Erstellen Sie Verträge über einen 4-Stufen-Leitfaden inklusive SHA-256-Verschlüsselungssiegel.',
      es: 'La etapa tres es el núcleo: el estudio de redacción unificado y la bóveda de plantillas certificadas. Redacte contratos institucionales con una guía de 4 pasos y sello criptográfico SHA-256.',
      zh: '第三阶段是平台核心：统一智能起草工作室与官方认证模板库。通过4步引导式路线图生成符合主权法律的商业合同，或搜索经合规审计的模板，附带SHA-256加密印章。',
      tr: 'Üçüncü aşama sistemin kalbidir: Akıllı Sözleşme Stüdyosu ve doğrulanmış şablon kasası. 4 adımlı kılavuz ile kurumsal sözleşmeler oluşturun ve SHA-256 dijital mühür uygulayın.',
    },
    icon: FileText,
    ...
    statutoryBadges: ['📜 نماذج قانونية معتمدة', '🔒 ختم مشفر SHA-256', '📥 تصدير Word و PDF', '✨ خريطة من 4 خطوات'],
    keySteps: [
