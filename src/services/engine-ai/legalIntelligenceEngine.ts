...
// ── 📜 Power of Attorney (POA / Wakala) Contract Generator ────────────────
export function generatePowerOfAttorneyContract(prompt: string, isAr: boolean = true): string {
  const p = prompt.toLowerCase();
  const isJordan = p.includes('أردن') || p.includes('الاردن') || p.includes('الأردن') || p.includes('jordan') || p.includes('jo');

  if (isJordan && isAr) {
    return `## ⚖️ نموذج مسودة وكالة عامة مطلقة وفقاً للقانون الأردني وقانون الكاتب العدل

**أنا الموقّع أدناه (الموكِّل الاصيل):**
* **الاسم الكامل:** [اسم الموكِّل الرباعي كما هو في البطاقة الشخصية / جواز السفر]
* **الرقم الوطني / رقم جواز السفر:** \`[............................................]\`
* **الجنسية:** [أردني / ....................] | **مكان وتاريخ الميلاد:** [....................]
* **العنوان ومحل الإقامة المختار:** [المملكة الأردنية الهاشمية - محافظة: ............... - مدينة: ............... - شارع: ...............]
* **رقم الهاتف:** [07.................] | **البريد الإلكتروني:** [....................]

قد أقرتُ بكامل أهليتي القانونية والشرعية المعتبرة، وبملء إرادتي وحريتي، وبلا إكراه أو تدليس، بأنني قد أقمتُ وفوضتُ ووكّلتُ عني:

* **الوكيل (المفوَّض):** [اسم الوكيل الرباعي الكامل]
* **الرقم الوطني / رقم جواز السفر:** \`[............................................]\`
* **الجنسية:** [أردني / ....................] | **العنوان ومحل الإقامة:** [................................................................]
* **رقم الهاتف:** [07.................] | **البريد الإلكتروني:** [....................]

---

### 🏛️ المرجعية القانونية والأساس التشريعي:
تم صياغة وإعداد هذا النموذج استناداً لأحكام **عقد الوكالة المادتين (833 - 867) من القانون المدني الأردني رقم 43 لسنة 1976**، وأحكام **قانون الكاتب العدل الأردني رقم 11 لسنة 1952 وتعديلاته**.

---

### 📋 أولاً: نطاق الصلاحيات والتفويضات العامة
ليقوم الوكيل المذكور أعلاه نيابةً عني وبالأصالة عن نفسي وباسمي وفي كافة الشؤون القانونية والمالية والإدارية والتجارية داخل المملكة الأردنية الهاشمية وخارجها، وتتضمن الصلاحيات الآتي:

1. **الإدارة العامة والمعاملات الإدارية والتجارية:**
   - إدارة كافة أموالي المنقولة وغير المنقولة، وتنسيق وحفظ مصالحي وشؤوني لدى كافة الوزارات والمؤسسات والدوائر الحكومية والرسمية والخاصة.
   - مراجعة **دائرة مراقبة الشركات (CCD)**، وزارة الصناعة والتجارة والتموين، غرف التجارة والصناعة، والتوقيع على عقود التأسيس والنظم الأساسية للشركات وتعديلاتها واستخراج السجلات التجارية وإصدار رخص المهن من أمانة عمان الكبرى والبلديات المختصة.

2. **المعاملات المالية والمصرفية:**
   - مراجعة البنوك والمؤسسات المالية المرخصة في الأردن وخارجها، وفتح الحسابات البنكية (جارية، توفير، ودائع) باسم الموكل، وإدارتها وإيداع الأموال وسحبها وإجراء التحويلات المصرفية.
   - استلام الشيكات وإصداره وإيداعها وتحصيلها، واستلام الصكوك والمبالغ المستحقة للموكل من أي جهة كانت، واستخراج كشوف الحسابات والمصادقة عليها.

3. **التمثيل أمام الدوائر الحكومية والجمارك والضريبة:**
   - مراجعة **دائرة ضريبة الدخل والمبيعات** والتوقيع على الإقرارات الضريبية واستلام ردّيات الضرائب وتسوية الملفات الضريبية.
   - مراجعة **دائرة الجمارك الأردنية** والمؤسسة العامة للضمان الاجتماعي، والتخليص على البضائع والسيارات واستلام المعاملات الرسمية والمراسلات.

4. **التمثيل القضائي والتقاضي والدفاع:**
   - مراجعة المحاكم الأردنية بجميع درجاتها (محاكم الصلح، البداية، الاستئناف، التمييز، والمحكمة الإدارية)، ومحاكم التنفيذ والإجراء.
   - توكيل واختيار المحامين والمستشارين القانونيين وتمثيل الموكل في كافة الدعاوى والأنشطة القضائية، وتوجيه الإخطارات والإنذارات العدلية وتدقيق الأوراق القضائية واستلام الأحكام والقرارات.

---

### ⚠️ ثانياً: القيود والاشتراطات الخاصة بموجب التشريعات الأردنية
* **الالتزام بالتوكيل الخاص للتصرفات العقارية:** يقر الطرفان بأن أي تصرفات ناقلة لملكية العقارات أو الأراضي (بيع، شراء، رهن، هبة) تخضع لأحكام **قانون الملكية العقارية الأردني رقم 13 لسنة 2019** وتستلزم نصاً صريحاً في وكالة خاصة عقارية معتمدة وموثقة لدى دائرة الأراضي والمساحة والكاتب العدل.
* **حظر التنازل والإقرار بالحقوق:** لا تبيح هذه الوكالة العامة للوكيل التنازل عن الحقوق الشخصية أو الإقرار بالديون أو الصلح أو الإبراء إلا بنص صريح خاص ومستقل.

---

### ⏳ ثالثاً: سريان الوكالة وحق العزل والإنهاء
* تسري هذه الوكالة اعتباراً من تاريخ توثيقها رسمياً لدى دائرة الكاتب العدل وتظل نافذة المفعول ما لم يتم إنهاؤها أو عزل الوكيل بموجب إشعار خطي عدلي موثق ومُبلّغ رسمياً، أو بوفاة أحد الطرفين أو زوال أهليته وفق أحكام المادة (862) من القانون المدني الأردني.

---

### ✍️ رابعاً: الإقرار والتوقيع وتصديق الكاتب العدل

**توقيع الموكِّل (الأصيل):** _______________________    **التاريخ:** [..../..../2026م]  
**توقيع الوكيل (للقبول والموافقة):** __________________    **التاريخ:** [..../..../2026م]  

**الشهود:**
1. **الشاهد الأول:** [اسم الشاهد] | **الرقم الوطني:** [....................] | **التوقيع:** ________________
2. **الشاهد الثاني:** [اسم الشاهد] | **الرقم الوطني:** [....................] | **التوقيع:** ________________

---
### 🏛️ تصديق دائرة الكاتب العدل الأردنية
**مكتب الكاتب العدل لدى محكمة:** [................................................................]  
**رقم قيد التوثيق:** \`[JO-POA-2026-.............]\` | **تاريخ التوثيق:** [..../..../2026م]  
**اسم وتوقيع الموثق الرسمي / الكاتب العدل:** _______________________  
*(خاتم الكاتب العدل الرسمي الأردني)*`;
  }

  if (isAr) {
    return `## ⚖️ نموذج مسودة وكالة عامة مطلقة موثقة (استرشادية)

**أنا الموقّع أدناه (الموكِّل الأصيل):**
* **الاسم الكامل:** [اسم الموكِّل الكامل]
* **رقم الهوية الوطنية / جواز السفر:** \`[............................................]\`
* **الجنسية:** [....................] | **العنوان ومحل الإقامة:** [................................................................]
* **الهاتف والبريد الإلكتروني:** [....................]

قد أقمتُ وفوضتُ ووكّلتُ عني:
* **الوكيل (المفوَّض):** [اسم الوكيل الكامل]
* **رقم الهوية الوطنية / جواز السفر:** \`[............................................]\`
* **الجنسية:** [....................] | **العنوان ومحل الإقامة:** [................................................................]
* **الهاتف والبريد الإلكتروني:** [....................]
...
1. **الإدارة والمعاملات العامة:** إدارة كافة الأموال المنقولة وغير المنقولة، وتنسيق كافة المعاملات الإدارية والتجارية لدى الوزارات والجهات الرسمية والخاصة.
2. **المعاملات المالية والمصرفية:** مراجعة البنوك والمؤسسات المالية، فتح وإدارة الحسابات المصرفية، إجراء التحويلات، وتسلّم المبالغ والصكوك الشيكات.
3. **التمثيل القضائي والتقاضي:** مراجعة المحاكم والهيئات القضائية بجميع درجاتها، وتعيين المحامين وتمثيل الموكل في كافة الدعاوى والنزاعات.

---

### 🛡️ القيود والمدة وحق العزل:
* تسري هذه الوكالة من تاريخ توثيقها لدى الكاتب العدل، وللموكل الحق في عزل الوكيل أو إلغاء الوكالة بإشعار خطي موثق.
* لا تشمل هذه الوكالة بيع العقارات أو التنازل عن الحقوق إلا بنص خاص وصريح وفق التشريعات المحلية.

---

### ✍️ الإقرار والتوقيع والشهود وتوثيق الكاتب العدل
**توقيع الموكِّل:** _______________________    **التاريخ:** [..../..../2026م]  
**توقيع الوكيل:** _______________________    **التاريخ:** [..../..../2026م]  

**الشهود:**
1. **الشاهد الأول:** [اسم الشاهد] | **الهوية:** [................] | **التوقيع:** ________________
2. **الشاهد الثاني:** [اسم الشاهد] | **الهوية:** [................] | **التوقيع:** ________________

*(خاتم وتصديق الكاتب العدل الرسمي)*`;
  }

  return `## ⚖️ GENERAL POWER OF ATTORNEY (DRAFT TEMPLATE)

**KNOW ALL MEN BY THESE PRESENTS**, that I, the undersigned **PRINCIPAL**:
* **Full Legal Name:** [Principal Full Name]
* **Passport / National ID No:** \`[............................................]\`
* **Nationality:** [....................] | **Address:** [................................................................]

Hereby appoint and constitute as my true and lawful **ATTORNEY-IN-FACT (AGENT)**:
...
1. **General Administration & Corporate Representation:** To manage all personal and commercial affairs, represent the Principal before governmental authorities, departments, and municipalities.
2. **Banking & Financial Transactions:** To open, maintain, and operate bank accounts, deposit and withdraw funds, execute wire transfers, and collect payments.
3. **Legal Representation & Litigation:** To represent the Principal before all courts of law, judicial tribunals, and retain legal counsel on the Principal's behalf.

---

### 🛡️ REVOCATION, DURATION & NOTARIZATION:
* This Power of Attorney shall remain in full force and effect until revoked in writing by the Principal or terminated by law.
* Conveyance of real estate assets requires a specialized specific Power of Attorney per local land registry statutes.

**IN WITNESS WHEREOF**, the Principal has executed this document on [Date: ...../...../2026].

**Principal Signature:** _______________________    **Date:** [...../...../2026]  
**Agent Signature:** _______________________    **Date:** [...../...../2026]  

*(Official Notary Public Authentication & Seal)*`;
}
...
export function solveLegalPrompt(prompt: string, lang: string = 'ar', history: ConversationTurn[] = []): string {
  ...
  // Agency / Power of Attorney / Wakala
  if (info.isAgency || /(power of attorney|poa|agency|wakala|mandate|وكالة|توكيل|تفويض|وكالة عامة|وكالة خاصة)/i.test(prompt)) {
    return generatePowerOfAttorneyContract(prompt, isAr);
  }
