  ...
  private injectGlobalSchemaOrg() {
    try {
      ...
      script.text = JSON.stringify({
        ...
        alternateName: 'JurisTech AI Legal Solutions & Verified Smart Legal Contracts Vault',
        url: typeof window !== 'undefined' ? window.location.origin : 'https://juristech.solutions',
        logo: 'https://juristech.solutions/logo.png',
        description: 'أكبر منظومة عقود قانونية ذكية في الشرق الأوسط والعالم — خزينة ونماذج قانونية معتمدة بالذكاء الاصطناعي',
